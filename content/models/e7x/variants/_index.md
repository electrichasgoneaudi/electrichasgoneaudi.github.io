...
**Core standard equipment** (included in price):

- Soft-close electric doors (value ¥5,000)
- Star Diamond Light Blade — AUDI family ring-shaped grille lighting (value ¥12,000)
- Super Sense Smart Package — ultra-wide display, Audi Assistant, Audi Smart Island, future digital cockpit (value ¥12,000)
...
The same six paint colors are available as on the Pioneer, with Flowing Silver and Monday Black included in the base price and the remaining four at ¥8,000 each.

Interior choices are identical to the Pioneer: Phantom Gray or Quantum Silver, with Openpore Natural Chestnut or Natural Oak inlay — all included in the price.

**Core standard equipment** (included in price):

- Soft-close electric doors (value ¥5,000)
- Star Diamond Light Blade — AUDI family ring-shaped grille lighting (value ¥12,000)
- Super Sense Smart Package — wide display, Audi Assistant, Audi Smart Island, future digital cockpit (value ¥12,000)
...
[See detailed specification](../specifications/#audi-e7x-pioneer-pro)
...
- **21-inch 8-spoke black alloy** — included, CLTC 635 km
- **22-inch 8-spoke black alloy** — with Brembo high-performance sport calipers and Audi floating hub covers, ¥5,500 extra, CLTC 615 km

Three interior colors are available:

- **Flowing Gold Brown** (鎏金棕) — standard
- **Quantum Silver** (量子银) — included
- **Ink Blue** (墨韵蓝) — ¥4,000

Inlays: Openpore Natural Chestnut (included) or Openpore Natural Oak (included).

**Core standard equipment** (included in price):

- **quattro Full-Time Intelligent AWD** — millisecond-level torque distribution, 10 ms real-time calculation, full torque chain response 30% faster than conventional AWD (value ¥30,000)
- Super Sense Smart Package — ultra-wide display, Audi Assistant, Audi Smart Island, future digital cockpit (value ¥12,000)
- **Audi Haute Couture Luxury Package** — Articite premium suede headliner + Feinnappa full-grain calf leather seats (value ¥14,000)
- OEKO-TEX® mother & baby grade full-cabin health certification (value ¥8,000)
...
- **21-inch 8-spoke black alloy** — included, CLTC 751 km
- **22-inch 8-spoke high-spec alloy** — with Brembo high-performance sport calipers and Audi floating hub covers, ¥5,500 extra, CLTC 730 km

Three interior colors are available (more choice than Pioneer/Pro):

- **Flowing Gold Brown** (鎏金棕) — included
- **Quantum Silver** (量子银) — included
- **Ink Blue** (墨韵蓝) — ¥4,000
...
Both 22-inch wheel options are included at no extra cost — a first in the E7X lineup:

- **22-inch 8-spoke high-spec alloy** — Brembo sport calipers and Audi floating hub covers, CLTC 660 km (included)
- **22-inch 8-spoke black alloy** — Brembo sport calipers and Audi floating hub covers, CLTC 660 km (included)

Two interior colors are available, both included at no extra cost:

- **Quantum Silver** (量子银) — standard
- **Ink Blue** (墨韵蓝) — included

Two inlay options are available, both included:

- **Openpore North American Natural Oak** (standard)
- **Openpore North American Natural Chestnut**

Physical mirrors available as no-cost option (digital camera mirrors standard).

**Core standard equipment** (included in price):

- **quattro Full-Time Intelligent AWD** — millisecond-level torque distribution, 10 ms real-time calculation, full torque chain response 30% faster (value ¥30,000)
- **Star Diamond Light Blade Upgrade Kit** — DLP high-definition digital projection headlights, 8 welcome/farewell animations, linked lighting design (value ¥22,000) — **core standard** on Flagship vs limited-time gift on lower variants
- Super Sense Smart Package — ultra-wide display, Audi Assistant, Audi Smart Island, future digital cockpit (value ¥12,000)
- OEKO-TEX® mother & baby grade full-cabin health certification (value ¥8,000)
- **Powered soft-close electric doors** — push gently, door closes silently (value ¥17,000)
...
- Foldable ultra-clear digital camera mirrors — sharp in rain, fog and night (value ¥12,000)
- Audi Track-level Chassis — rear-wheel steering, all-aluminum chassis, CDC + air suspension (value ¥30,000)
- **9.1.4.8 BOSE Performance sound system** — upgraded 9.1.4.8 immersive audio architecture, four world-first technologies, DSP processing up to 2,000 MIPS, intelligent road noise isolation (value ¥15,000)
- **Palace-Class Zero-Pressure Four-Seat First-Class Cabin** — 21.4-inch QD Mini LED rear ceiling screen, smart four-season cooler/warmer box, dual rear zero-gravity seats (value ¥59,000) — replaces Audi Smart Living Room on lower variants

[See detailed specification](../specifications/#audi-e7x-flagship-quattro)
