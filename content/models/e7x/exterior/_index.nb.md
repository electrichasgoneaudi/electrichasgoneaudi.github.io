---
title: AUDI E7X eksteriør
linktitle: Eksteriør
description: AUDI E7X har et dristig og fremtidsrettet SUV-design med seks tilgjengelige lakkfarger, vertikale Matrix LED-frontlykter og et markant monolittisk karosseriuttrykk.
weight: 4
---
<!-- markdownlint-disable MD033 -->

Eksteriørdesignet til AUDI E7X er direkte inspirert av AUDI E SUV-konseptet og oversetter et progressivt og selvsikkert designspråk til en produksjonsklar stor elektrisk SUV.
...
AUDI-merkevareidentiteten — med merkenavnet skrevet med store bokstaver i stedet for Audis fire ringer — er tydelig synlig og understreker AUDIs særegne posisjonering som et Kina-spesifikt merke.

## Dimensjoner

E7X har et dominerende fotavtrykk i segmentet for store premium-SUV-er:
...
AUDI E7X er tilgjengelig i seks eksteriørfarger:

- **Monday Black** (ensfarget sort)
- **Flowing Silver** (metallisk sølv)
- **Nebula Purple** (metallisk lilla)
- **Dark Rock Beige** (lys beige)
- **Misty Blue** (metallisk blå)
- **Titanium Gray** (metallisk grå)
...
Fra **Pioneer Pro** og oppover leveres E7X med standard **digitale kamerabaserte sidespeil** som erstatter konvensjonelle glasspeil. Tradisjonelle fysiske speil er tilgjengelig som kostnadsfritt tilvalg.
