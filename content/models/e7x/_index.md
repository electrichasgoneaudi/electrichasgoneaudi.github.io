...
The **AUDI E7X** is a **China-exclusive, fully electric premium SUV** and the **second production model** from **AUDI**, the China-only sister brand created through the cooperation between :contentReference[oaicite:0]{index=0} and :contentReference[oaicite:1]{index=1}. Following the AUDI E5 Sportback, the E7X further expands Audi’s localized electric portfolio tailored specifically to Chinese customers.
