---
title: Audi e-tron GT emergency assist
linktitle: Emergency assist
description: Audi e-tron GT can be delivered with emergency assist. Emergency assist detects, within system limits, when the driver is inactive. In such a case, the system assumes control of the vehicle and automatically brakes it to a standstill in its own lane.
weight: 1
---
...
This option is part of [the tour driver assistance package](../../../optionguide/list/#driver-asssist-systems) with option id **PCC**
