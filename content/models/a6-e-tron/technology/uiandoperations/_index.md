---
title: Audi A6 e-tron user interface and operations
linktitle: Interface & operations
description: The Audi A6 e-tron model series has a fully connected and digital interior based on the new electronic architecture. Made up by the Audi MMI panoramic display and the MMI passenger display, the so-called Digital Stage is a key feature of the interior.
weight: 4
---

{{< sitefiguresized thumb="https://media.evkx.net/ehga/models/q6-e-tron/technology/uiandoperations/virtualcockpit/virtualcockpit_1_st.webp" width="1920" height="900" title="Audi A6 e-tron with virtual cockpit and MMI Panorama" >}}
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>MMI</h2>
	<p>
		The Audi A6 e-tron MMI is based on Android Automotive and uses several displays.
	</p>
	<a href="mmi/" class="btn btn-outline-primary" role="button">Learn all about Audi A6 e-tron MMI</a>
</div>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<a href="headupdisplay/" class="btn btn-outline-primary" role="button">Learn all about the Audi A6 e-tron head-up display</a>
</div>
